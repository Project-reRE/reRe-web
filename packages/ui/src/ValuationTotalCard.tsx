...
const ValuationTotalCard = ({}: Props) => {
  return (
    <div className="flex h-[246px] flex-col items-center gap-[35px] rounded-[14px] bg-neutral-800 px-[24px] py-[20px]">
      <p className="w-full text-[15px] font-medium leading-[18px] text-[#d1d1d1]">7월, 재평가에 참여한 사람들</p>
      <div className="flex flex-col gap-[5px]">
        <p className="text-xs font-normal leading-[14px] text-[#b3b3b3]">평가자 수</p>
        <p className="text-xl font-bold leading-[24px] text-[#d1d1d1]">000,000,000명</p>
      </div>
      <div className="flex flex-col gap-[5px]">
